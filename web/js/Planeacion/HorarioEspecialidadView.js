...
function inicio(contex) {
    ...
    $(".modificar").click(
        function(e) {
            ...
            var idHorarioEspecialidad = $(this).data("id");
            var idProfesor = $(this).data("profesor");
                        
            $.getJSON(context + '/consultarProfesorHorarioEspecialidad', {
                idHorarioEspecialidad: idHorarioEspecialidad
            }).done(function(data) {
                ...
                $.each(data.prof, function(posicion, profesor) {
                    ...
                    var opcion = $('<option value="' + profesor.idProfesor + '">' + '</option>')
            ...
            $("#idHorarioEspecialidadM").val($(this).data("id"));
            $("#nombreMateriaM").val($(this).data("nombremateria"));
            $("#idEspecialidadesM").val($(this).data("especialidad"));
        ...
        function(e) {
            ...
            alertify.confirm("¿Estás seguro de eliminar el horario?", function(e) {
                if (e) {
                    ...
                    $('#idHorarioEspecialidadM').val(idHE);
                    $('#form2').attr('action', context + "/eliminarHorarioEspecialidad");
                    $('#form2').submit();
                } else {
